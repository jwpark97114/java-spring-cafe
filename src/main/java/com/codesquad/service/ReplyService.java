...
public class ReplyService {
    ...
    public Slice<ReplyDTO> findReplySliceByArticleId(int articleId, int pageNumber){
        Pageable pageable = PageRequest.of(pageNumber, 5, Sort.by("createdAt").ascending());
        return this.repo.findReplyByArticleId(articleId, pageable).map(ReplyDTO::of);
    }
